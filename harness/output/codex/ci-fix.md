<!-- Generated from skills/ci-fix.md by harness/codex.ts — DO NOT EDIT DIRECTLY -->
...
- Maximum 5 files changed per fix attempt
- Never modify CI config files
- If tests pass locally but fail in CI, do not change code (likely flaky)
