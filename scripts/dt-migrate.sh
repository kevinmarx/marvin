#!/usr/bin/env bash
# Deep Thought — Database migration runner
...
MIGRATIONS_DIR="$PROJECT_DIR/schema/dt-migrations"
STATE_DIR="$HOME/.deep-thought/state"
DB_PATH="$STATE_DIR/deep-thought.db"
